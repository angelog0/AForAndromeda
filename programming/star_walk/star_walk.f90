...
!
!   created   : Jun 26, 2023
!   last edit : Dec 28, 2024 (was star_walk_2d)
!
!   Star Walk of NSTARS
!
! DESCRIPTION
!
!   We draw the (2D) star walk using FORTRAN-SDL2 interface. The stars
...
module star_walk_lib
  ...
  character(len=*), parameter :: TITLE = 'The Star Walk'
  ...
  real(WP) :: xsize = 300, view_xsize = 300, step = 1
  ...
  real(WP) :: x_min, x_max, y_min, y_max, f(2), &
       ysize, view_ysize, &
       rms_d, mean_x, mean_y, sigma_x, sigma_y, density, rval
...
contains
  ...
  contains
    ...
    ! Total "force" of the remaining NSTARS-1 stars on star at position Q(:)
